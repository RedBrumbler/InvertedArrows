...
LOCAL_LDLIBS += -llog
LOCAL_CFLAGS += -I'D:/il2cpp/libil2cpp' -isystem 'extern' -I'extern/codegen/include' -DMODDEBUG='false' -DID='"InvertedArrows"' -DVERSION='"1.0.2"' -I'./shared' -I'./extern' -Wno-inaccessible-base
