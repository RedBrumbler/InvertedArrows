...
LOCAL_LDLIBS += -llog
LOCAL_CFLAGS += -I'extern/libil2cpp/il2cpp/libil2cpp/' -isystem 'extern' -I'extern/codegen/include' -DID='"InvertedArrows"' -DVERSION='"1.0.4"' -I'./shared' -I'./extern' -Wno-inaccessible-base
